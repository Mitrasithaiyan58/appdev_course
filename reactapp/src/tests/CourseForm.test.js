...
test("renders form fields and validates required fields", async () => {
  render(<CourseForm />);
...
test("shows validation errors for constraints", async () => {
  render(<CourseForm />);
...
test("submits form and displays success message on success", async () => {
