...
describe('App Component', () => {
  test('renders App with header and default view', () => {
    render(<App />);
  ...
  test('navigates to Add Course view when "Add Course" is clicked', () => {
    render(<App />);
  ...
  test('navigates back to Course List view when "View Courses" is clicked', () => {
    render(<App />);
